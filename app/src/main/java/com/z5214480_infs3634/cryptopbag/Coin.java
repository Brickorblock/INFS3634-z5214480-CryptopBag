...
public class Coin {
    ...
    public Coin coinSearch(String symbol) {
        ArrayList<Coin> myCoins = getCoins();

        Coin myCoin = myCoins.get(0);

        if (symbol.equals("BTC")){
            myCoin = myCoins.get(0);
        } else if (symbol.equals("ETH")){
            myCoin = myCoins.get(1);
        } else if (symbol.equals("XRP")){
            myCoin = myCoins.get(2);
        } else if (symbol.equals("BCH")){
            myCoin = myCoins.get(3);
        } else if (symbol.equals("BCHSV")){
            myCoin = myCoins.get(4);
        } else if (symbol.equals("USDT")){
            myCoin = myCoins.get(5);
